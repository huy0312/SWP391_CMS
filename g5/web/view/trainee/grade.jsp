...
<html lang="en">
    ...
    <head>
        ...
        <title>CMSLVL10 - CLASS GRADE</title>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="page-title">Class Grades</h3>
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Class Grades</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                            ...
                                            <table class="table table-hover table-center mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="sortable" data-sort="attempt">
                                                            Attempt<i class="fas fa-sort"></i>
                                                        </th>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.grades}" var="c">
                                                        <tr>
                                                            <td>${c.gradeId}</td>
                                                            <td>
                                                                <h2>
                                                                    <a class="text-info">${c.gradeName}</a>
                                                                </h2>
                                                            </td>
                                                            <td>
                                                                <c:if test="${c.gradeType eq 1}">
                                                                    Quiz
                                                                </c:if>
                                                                <c:if test="${c.gradeType eq 2}">
                                                                    Assignment
                                                                </c:if>
                                                            </td>
                                                            <td>${c.grade}</td>
                                                            <td>${c.attempt}</td>
                                                            <td class="text-truncate">${c.note}</td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
                        ...
                        <c:if test="${empty requestScope.grades}">
                            <div class="col-sm-12">
                                <div class="card card-table">
                                    <div class="card-body">
                                        <div class="alert alert-secondary alert-dismissible fade show" role="alert">
                                            You have't have any grade yet.
                                        </div>
                                    </div>
                                </div>
                            </div>
