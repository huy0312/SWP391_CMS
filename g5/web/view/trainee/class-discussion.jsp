...
<html lang="en">
   ...
   <head>
      ...
      <title>CMSLVL10 - Class Discussion</title>
                  ...
                  <div class="col-sm-12">
                    <section class="comp-section">
                        <div class="section-header">
                          <h4 class="section-title">Thread</h4>
                          <div class="line"></div>
                        </div>
                        <div class="row mb-4">
                          <div class="col-md-12">
                            <div class="profile-header">
                              <div class="row">
                                <div class="col-auto profile-image">
                                  ...
                                  <p class="text-center mt-3"><small>1-11-2023 21:40</small></p>
                                </div>
                                <div class="col ml-md-n2 profile-user-info">
                                  <h4 class="user-name">Nguyen Hai Minh</h4>
                      ...
                      <section class="comp-section">
                        ...
                        <div class="row">
                          <div class="col">
                            ...
                            <div class="row">
                              <div class="col text-right float-right ml-auto">
                                <a href="add-student.html" class="btn btn-primary"><i class="fas fa-paper-plane"></i> Send</a>
                             </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-lg-12 col-12">
                            <div class="row">
                              ...
                              <div class="col-10 col-lg-11">
                                ...
                                <p class="mb-0"><small>1-11-2023 21:40</small></p>
                            ...
                            <div class="row">
                              ...
                              <div class="col-10 col-lg-11">
                                <p class="mb-0"><strong>Hello</strong></p>
                                <p class="mb-0"><small>1-11-2023 21:38</small></p>
                                <div class="card card-body">
                                 Hallo
                                </div>
                              </div>
