...
<html lang="en">
    ...
    <head>
        ...
        <title>CMSLVL10 - NEW  SUBJECT</title>
    ...
    <body>
                    ...
                    <div class="content container-fluid">
                        ...
                        <div aria-live="polite" aria-atomic="true" style="position: relative; z-index: 11">
                            <div class="toast bg-danger text-white border-0" id="errorToast" data-delay="1000" data-autohide="true" role="alert" aria-live="assertive" aria-atomic="true" style="position: fixed; bottom: 20px; right: 20px;">
                                <div class="toast-body">
                                    Subject is collied! Try another.
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <!--NAVIGATION START-->
                                <div class="col">
                                    <h3 class="page-title">NEW SUBJECT</h3>
                                    <ul class="breadcrumb">
        ...
        <script>
            $(document).ready(function () {
                $("#addNewSubjectForm").submit(function (event) {
                    event.preventDefault(); // Prevent the default form submission
                    var formData = $(this).serialize();
                    $.ajax({
                        type: "POST",
                        url: "subject-list?action=add",
                        data: formData,
                        success: function (response) {
                            console.log(response);
                            if (response.trim() === "success") {
                                window.location.href = 'subject-list?action=view&success=true';
                                console.log("success");
                            } else {
