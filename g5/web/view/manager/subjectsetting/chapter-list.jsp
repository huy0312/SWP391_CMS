...
<html lang="en">
    ...
    <head>
        ...
        <title>CMSLVL10 - Chapter List</title>
                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <!--NAVIGATION START-->
                            <div class="col">
                                <h3 class="page-title">Chapter List</h3>
                                <ul class="breadcrumb">
                            ...
                            <div class="col-auto text-right float-right ml-auto">
                                <button type="button" onclick="window.location.href = 'chapter-list?action=add'" class="btn btn-rounded btn-outline-info">Add chapter</button>
                            </div>
                            <!--ADD BUTTON END-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-center mb-0 ">
                                            ...
                                            <tbody>
                                                <c:forEach items="${chapter}" var="c">
                                                    <tr>
                                                        <td>${c.chapterId}</td>
                                                        <td class="text-truncate" data-toggle="tooltip" title="${c.chapterName}">${c.chapterName}</td>
                                                        <td class="text-truncate" data-toggle="tooltip" title="${c.subject.subjectName}">${c.subject.subjectName}</td>
                                                        <td>
                                                            <input name="status" id="statusCheck${c.chapterId}"
                                ...
                                <div>
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item ${currentPage eq 1 ? 'disabled' : ''}">
                                            <a class="page-link" 
                                               href="chapter-list?action=view&page=${currentPage - 1}&keyword=${keyword}&status=${statusSaved}&subject=${subjectIdSaved}" 
                                               tabindex="-1">
                                                Previous
                                            </a>
                                        </li>
                                        <c:forEach begin="1" end="${noOfPages}" var="i">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li class="page-item">
                                                        <a class="page-link" 
                                                           href="chapter-list?action=view&page=${i}&keyword=${keyword}&status=${statusSaved}&subject=${subjectIdSaved}">
                                                            ${i}
                                                        </a>
                                                    </li>
                                                </c:otherwise>
      ...
      <script>
            $(document).ready(function () {
                ...
                $('input[name="status"]').on('change', function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'chapter-list?action=update-status',
                        data: {
                            chapterId: chapterId,
                            status: newStatus
                        },
