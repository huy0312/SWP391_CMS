...
<html lang="en">
    ...
    <head>
        ...
        <title>CMSLVL10 - NEW DIMENSION</title>
    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <jsp:include page="../../components/general/sidebar.jsp">
                <jsp:param name="isDimensionList" value="1"></jsp:param>
            </jsp:include>
                ...
                <div class="content container-fluid">
                    ...
                    <div aria-live="polite" aria-atomic="true" style="position: relative; z-index: 11">
                        <div class="toast bg-danger text-white border-0" id="errorToast" data-delay="1000" data-autohide="true" role="alert" aria-live="assertive" aria-atomic="true" style="position: fixed; bottom: 20px; right: 20px;">
                            <div class="toast-body">
                                Dimension is collied! Try another title.
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <!--NAVIGATION START-->
                            <div class="col">
                                <h3 class="page-title">NEW DIMENSION</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="home">Home</a></li>
                                    <li class="breadcrumb-item"><a href="dimension-list?action=view">Dimension List</a></li>
                                    <li class="breadcrumb-item active">New Dimension</li>
                                </ul>
                            </div> 
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="addNewDimensionForm" >
                                        <div class="row">
                                            <div class="col-12">
                                                <h5 class="form-title"><span>Dimension Information</span></h5>
                                            </div>
                                            <div class="col-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>Type <span class="text-danger"></span></label>
                                                    <input id="dimensionType" name="dimensionType" type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>Name <span class="text-danger"></span></label>
                                                    <input id="dimensionName" name="dimensionName" type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-12">
                                                <div class="form-group">
                                                    <label for="description">Description:</label>
                                                    <textarea id="description" name="description" rows="6" cols="96"></textarea>
                                                </div>
                                            </div>
            ...
            <script>
                $(document).ready(function () {
                    $("#addNewDimensionForm").submit(function (event) {
                        event.preventDefault(); // Prevent the default form submission
                        var formData = $(this).serialize();
                        $.ajax({
                            type: "POST",
                            url: "dimension-list?action=add",
                            data: formData,
                            success: function (response) {
                                console.log(response);
                                if (response.trim() === "success") {
                                    window.location.href = 'dimension-list?action=view&success=true';
                                    console.log("success");
                                } else {
