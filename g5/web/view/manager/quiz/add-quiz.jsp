                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <!--NAVIGATION START-->
                            <div class="col">
                                <h3 class="page-title">NEW QUIZ</h3>
                                <ul class="breadcrumb">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="subject" id="subject" onchange="getAll()" class="form-control">
                                                        ...
                                                        $(function () {
                                                            ...
                                                            $(document).ready(function () {
                                                                ...
                                                                $("#addNewQuizForm").submit(function (event) {
                                                                    ...
                                                                    $.ajax({
                                                                        type: "POST",
                                                                        url: "quiz-list?action=add", // Use the URL of your AddUserServlet
                                                                        data: formData,
                                                                        success: function (response) {
                                                                            if (response.trim() === "fail") {
                                                                                ...
                                                                                window.location.href = 'quiz-list?action=view&success=true';
                                                                            }
                                                                        },
                                                                        error: function () {
                                                                            $('#errorToast').toast('show');
