...
<html lang="en">
    ...
    <head>
        ...
        <title>CMSLVL10 - LESSON DETAILS</title>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="lesson-list?action=view">Lesson List</a>
                                    </li>
                                                    ...
                                                    <select 
                                                        ...
                                                        <c:forEach items="${subjects}" var="r">
                                                            <option value="${r.subjectId}"
                                                                    ${requestScope.lesson.chapter.subject.subjectId eq r.subjectId ? 'selected' : ''}
                                                    ...
                                                    <select 
                                                        ...
                                                        <c:forEach items="${chapters}" var="r">
                                                            <option value="${r.chapterId}"
                                                                    ${requestScope.lesson.chapter.chapterId eq r.chapterId ? 'selected' : ''}
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="duration" name="duration" type="number" min="1" value="${requestScope.lesson.quiz.duration}" class="form-control" ${requestScope.lesson.lessonType == 2 ? 'required' : ''}>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </c:when>
                ...
                $(document).ready(function () {
                    ...
                    $("#updateLessonForm").submit(function (event) {
                        ...
                        if (isValid) {
                            $.ajax({
                                type: "POST",
                                url: "lesson-list?action=update", // Use the URL of your AddUserServlet
                                processData: false, // Don't process the data
                                contentType: false, // Don't set content type (it will be set automatically)
                                data: formData,
                                success: function (response) {
                                    if (response.trim() === "quizFailed") {
