...
<html lang="en">
    ...
    <head>
        ...
        <title>CMSLVL10 - NEW LESSON</title>
                ...
                <div class="content container-fluid">
                    ...
                    <div aria-live="polite" aria-atomic="true" style="position: relative; z-index: 11">
                        <div class="toast bg-danger text-white border-0" id="errorToast" data-delay="2000" data-autohide="true" role="alert" aria-live="assertive" aria-atomic="true" style="position: fixed; bottom: 20px; right: 20px;">
                            <div class="toast-body">
                                Lesson is collied! Try another title.
                                <button type="button" class="ml-2 mb-1 close" data-dismiss="toast">&times;</button>
                            </div>
                        </div>
                    </div>
                    <div aria-live="polite" aria-atomic="true" style="position: relative; z-index: 11">
                        <div class="toast bg-danger text-white border-0" id="quizErrorToast" data-delay="2000" data-autohide="true" role="alert" aria-live="assertive" aria-atomic="true" style="position: fixed; bottom: 20px; right: 20px;">
                            <div class="toast-body">
                                Please enter an available date.
                                <button type="button" class="ml-2 mb-1 close" data-dismiss="toast">&times;</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="lesson-list?action=view">Lesson List</a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="addNewLessonForm" class="needs-validation" enctype="multipart/form-data" novalidate>
                                        <div class="row">
                                            <div class="col-12">
                ...
                $(document).ready(function () {
                    ...
                    $("#addNewLessonForm").submit(function (event) {
                        ...
                        if (isValid) {
                            $.ajax({
                                type: "POST",
                                url: "lesson-list?action=add", // Use the URL of your AddUserServlet
